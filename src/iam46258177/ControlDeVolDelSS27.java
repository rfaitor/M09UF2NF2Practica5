...
class ControlDeVolDelSS27 {
    ...
    public ControlDeVolDelSS27(int x, int y, int dsx, int dsy, int v ){
        this.x = x;
        this.y = y;
        this.dsx = dsx;     //Val 1 sempre.
        this.dsy = dsy;     //Val 1 sempre.
        this.v = v;
        image = new ImageIcon(ControlDeVolDelSS27.class.getResource("nau.png")).getImage();
    }
